...
impl From<BlockHeader> for BlockHeaderView {
    fn from(header: BlockHeader) -> Self {
        Self {
            ...
            last_final_block_height: header.last_ds_final_block_height().clone(),
            last_ds_final_block: header.last_ds_final_block().clone(),
            last_ds_final_block_height: header.last_ds_final_block_height().clone(),
        ...
        if view.latest_protocol_version <= 29 {
            ...
            let mut header = BlockHeaderV1 {
                ...
                inner_rest: BlockHeaderInnerRest {
                    ...
                    last_final_block_height: view.last_final_block_height,
                    last_ds_final_block: view.last_ds_final_block,
                    last_ds_final_block_height: view.last_ds_final_block_height,
